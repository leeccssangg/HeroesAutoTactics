...
namespace Combat
{
    [CreateAssetMenu(menuName = "AbilityPower/GiveStatPower")]
    public class GiveStatPower : AbilityPower
    {
        ...
        {
            await to.GainStat(Attack, Health, from.Transform.position, to.Transform.position, tickRate, cancellationToken);
        }
    }
}