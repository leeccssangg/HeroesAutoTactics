...
[Serializable]
public class ActivitySelectHeroSynergyContext 
{
    ...
    public class UIModel : IAModel
    {
        ...
        {   
            HeroSynergy.Value = HeroManager.Instance.InventorySynergy;
    ...
    public class UIPresenter : IAPresenter, IActivityLifecycleEventSimple
    {
        ...
        public async UniTask Initialize(Memory<object> args)
        {
            ...
            {
                Synergy = (Family)i;
                if (Synergy == HeroManager.Instance.InventorySynergy)
                    continue;
        ...
        {
            HeroManager.Instance.ChangeInventorySynergy(synergy);
            HideActivity();
        }
        ...
        {
            ActivityContainer.Find(ContainerKey.Activities).HideAsync(nameof(ActivitySelectHeroSynergy));
        }
    }
}