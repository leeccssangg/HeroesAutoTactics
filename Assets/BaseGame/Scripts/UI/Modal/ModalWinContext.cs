...
public class ModalWinContext 
{
    ...
    public class UIPresenter : IAPresenter, IModalLifecycleEventSimple
    {
        ...
        //public override UniTask DidPushEnter(Memory<object> args)
        //{
        ...
        private void PlayAnimWinCup()
        {
            for (int i = 0; i < View.ListUICupHero.Count; i++)
            {
                ...
                {
                    View.ListUICupHero[i].PlayAnimWinCup();
                    return;
                }
            }
        }
        ...
        private void SetupUIHeart()
        {
            for(int i = 0;i< View.ListUIHeartHero.Count;i++)
            {
                ...
                if(i+1> Model.HeartCount)
                {
                    View.ListUIHeartHero[i].PlayAnimInitLose();
                }
            }
        }
        private async UniTask WaitToChangeBackToGame()
        {
