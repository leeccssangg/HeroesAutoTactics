...
namespace Combat
{
    public class RemoveStatPowerPercentPower : AbilityPower
    {
        ...
        {
            await to.RemoveStatPercent(Attack, Health, from.Transform.position, to.Transform.position, tickRate, cancellationToken);
        }
    }
}